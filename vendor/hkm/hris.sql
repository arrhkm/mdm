...
-- Schema hris
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `hris` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `hris` ;
...
-- -----------------------------------------------------
-- Table `hris`.`period_year`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hris`.`period_year` (
  `id` INT NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `hris`.`leave_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hris`.`leave_type` (
...
-- -----------------------------------------------------
-- Table `hris`.`leave_request`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hris`.`leave_request` (
  ...
  CONSTRAINT `fk_leave_request_employee1`
    ...
    REFERENCES `hris`.`employee` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_leave_request_leave_type1`
    FOREIGN KEY (`leave_type_id`)
    REFERENCES `hris`.`leave_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `hris`.`leave`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hris`.`leave` (
  ...
  CONSTRAINT `fk_leave_leave_request1`
    ...
    REFERENCES `hris`.`leave_request` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `hris`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hris`.`user` (
...
-- -----------------------------------------------------
-- Table `hris`.`leave_entitlement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hris`.`leave_entitlement` (
  `id` INT(11) NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `hris`.`leave_has_leave_entitlement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hris`.`leave_has_leave_entitlement` (
  `id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
...
-- -----------------------------------------------------
-- Table `hris`.`leave_request_comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hris`.`leave_request_comment` (
...
-- -----------------------------------------------------
-- Table `hris`.`leave_comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hris`.`leave_comment` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `leave_id` INT(11) NOT NULL COMMENT '',
  `employee_id` INT NULL COMMENT '',
  `user_id` INT(11) NOT NULL COMMENT '',
