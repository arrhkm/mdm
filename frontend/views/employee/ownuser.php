...
<div class="employee-view">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-4">
            <img src= <?= 'data:image/jpg;base64,'.base64_encode($model['employee_picture'])?> class="center-block img-circle img-thumbnail img-responsive" height="200px" width="200px">                     
        </div>
